    ...
    <script>
     /*   function submitForm(){
        ...
        function addNewRow(){
            ...
            $('#bb').append(" <tr><td>2</td><td><select name='sort' style='width: 140px;' ></select></td><td><select name='address' style='width: 140px;'></select></td> <td><input type='button' value='删除'/></td> </tr>");

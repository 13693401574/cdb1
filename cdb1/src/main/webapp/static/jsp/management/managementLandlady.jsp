            ...
            <div data-options="region:'center',title:'包租婆车位信息'">
                <table class="easyui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field:'listprice',width:80,align:'right'">身份证号码</th>
                        <th data-options="field:'unitcost',width:80,align:'right'">电话号码</th>
                        <th data-options="field:'attr1',width:250">车位编号</th>
                        <th data-options="field:'status',width:60,align:'center'">产权证编号</th>
                    </tr>
                ...
                <div style="padding:5px 0;margin-left: 60%">
                    <a href="#" class="easyui-linkbutton" style="width: 120px;height: 30px;margin-left: 30px;margin-top: 20px" data-options="iconCls:'icon-search'" onclick="$('#w').window('open')">查看车位信息</a>
        ...
        <div id="w" class="easyui-window" title="查看车位信息" data-options="modal:true,closed:true" style="width:400px;height:auto;">
            <div class="easyui-panel">
                ...
                <div style="text-align:center;padding:5px;margin-top: 350px">
                    <a href="javascript:void(0)" class="easyui-linkbutton btn" onclick="$('#w').window('close')">审批通过</a>
                    <a href="javascript:void(0)" class="easyui-linkbutton btn" onclick="$('#w').window('close')">驳回</a>
